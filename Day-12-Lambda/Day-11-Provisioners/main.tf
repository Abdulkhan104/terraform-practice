...
resource "aws_instance" "server" {
  ami                         = "ami-0a716d3f3b16d290c" # Ubuntu AMI
...
#     private_key = file("C:/Users/admin/.ssh/id_ed25519")             # Path to private key
#     host        = self.public_ip
#     timeout     = "2m"
#   }
...
#     ]
#   }
#    provisioner "local-exec" {  #where terraform is running inside the dir
...
resource "null_resource" "run_script" {
  provisioner "remote-exec" {
    ...
    inline = [
      "echo 'hello from abdul' >> /home/ubuntu/file200"
    ]
  }
